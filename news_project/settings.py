...
SECRET_KEY = 'django-insecure-ri(wdiv8^epc1ckb62+t7i1*bqit5%+@=mkc=c!&@x1gxm$9l@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # context_processor base.html yoki boshqa sahilafarda ma'lumotlarni kirgizish. Ya'ni xamma templateda ishlatish mumkin
